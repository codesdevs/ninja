...
module.exports = class JDBean {
    ...
    async totalBean() {
        ...
        this.currentJingdou = response.data.data.assetInfo.beanNum;
        this.currentRedenvelope = response.data.data.assetInfo.redBalance;
        return {
            currentJingdou: this.currentJingdou,
            // currentRedenvelope: this.currentRedenvelope,
        }
    }
    async bean() {
        //获取总京豆和总红包
        ...
        return {
            currentJingdou: this.currentJingdou,
            redBalance: this.currentRedenvelope,
            jingxiRedenvelope: this.jingxiRedenvelope,
            speedRedenvelope: this.speedRedenvelope,
            jdRedenvelope: this.jdRedenvelope,
        }
    ...
    async redPacket() {
        ...
        let expiredBalance = (jxRedExpire + jsRedExpire + jdRedExpire).toFixed(2)
        console.log("京喜红包：" + jxRed);
        this.jingxiRedenvelope = jxRed + "元 今天总过期：" + jxRedExpire.toFixed(2) + "元";
        this.speedRedenvelope = jsRed + "元 今天总过期：" + jsRedExpire.toFixed(2) + "元";
        this.jdRedenvelope = jdRed + "元 今天总过期：" + jdRedExpire.toFixed(2) + "元";
        this.currentRedenvelope = this.currentRedenvelope + "元 今天总过期：" + expiredBalance + "元";
        return {
            currentRedenvelope: this.currentRedenvelope,
            jingxiRedenvelope: this.jingxiRedenvelope,
            speedRedenvelope: this.speedRedenvelope,
...
//     // if (response.body.data.retcode === "0" && data.data && data.data.hasOwnProperty("userInfo")) {
